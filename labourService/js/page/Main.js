    ...
    headerComponent() {
        ...
        return <View style={{backgroundColor: '#fff'}}>
            ...
            <View style={{flexDirection: 'row', justifyContent: 'space-around'}}>
                {this.itemView(src.woyaoqingjia_btn, "平台项目", () => Actions.leave())}
                {this.itemView(src.woyaofuke_btn, "我要招工", () => Actions.leaveList())}
                {this.itemView(src.jiankangjiaoyu_btn, "建筑资讯", () => {
                    Actions.more()
                })}
                {this.itemView(src.gerendangan_btn, "完善资料", () => Actions.recordList())}
